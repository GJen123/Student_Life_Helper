...
public class LifeStyleWrongActivity extends AppCompatActivity {
    ...
    EditText etHour,etEvent,etLocation,etLat,etLong;
    RadioButton rbScheduleYes,rbScheduleNo;
    String postHour,postEvent,postLocation,postLong,postLat,postWeekly,postSchedule,postUser_id;
    ...
    void findviews(){
        etHour = (EditText)findViewById(R.id.editText17);
    ...
    public void onLifeStyleWrongOK(View v){
        ...
        time = "2016-"+month+"-0"+date+"T"+hour+":00:00";
